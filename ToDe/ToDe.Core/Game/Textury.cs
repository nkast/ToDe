...
namespace ToDe
{
    public enum ZakladniDlazdice
    {
        ...
        Ohen_Kulomet = 8,
        Plocha_Prekazka_Kamen_1 = 9,
        Plocha_Prekazka_Kamen_2 = 10,
        Plocha_Prekazka_Kamen_3 = 11,
        Plocha_Prekazka_Ker_1 = 12,
        Plocha_Prekazka_Ker_2 = 13,
        Plocha_Prekazka_Ker_3 = 14,
        Plocha_Prekazka_Ker_4 = 15,
        Plocha_Prekazka_Ker_5 = 16,
        Raketa_1 = 17,
        Raketa_2 = 18,
